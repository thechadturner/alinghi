  ...
  try {
    ...
    if (hasRace) {
      ...
      SELECT d.source_name,
        ...
        a."Bsp_start_kph" AS start_speed,
        a."Vmg_avg_kph" AS vmg_avg,
        a."Vmg_perc_avg" AS vmg_perc_avg,
        a."Polar_perc_avg" AS polar_perc_avg,
        a."Distance_m" AS distance_m,
        a."Bsp_max_kph" AS max_speed,
        a."RH300_perc" AS rh300_perc,
        a."RH750_perc" AS rh750_perc,
        a."RHgood_perc" AS rhgood_perc,
        a."RH1400_perc" AS rh1400_perc,
      ...
      SELECT d.source_name,
        ...
        AVG(a."Bsp_start_kph") AS start_speed,
        ...
        AVG(a."RH300_perc") AS rh300_perc,
        AVG(a."RH750_perc") AS rh750_perc,
        AVG(a."RHgood_perc") AS rhgood_perc,
        AVG(a."RH1400_perc") AS rh1400_perc,
